			...
			<div class="grid">
				...
				<nav class="header__navigation">
					...
					<ul class="header__navigation-list">
						...
						<i><a href="Profile.php" class="header__navigation-icon fas fa-user-circle" id="profile"></a></i>
						<a href="Profile.php" class="header__nav-link header__nav-signIn">Profile</a>
						</li>
						<li class="header__navigation-item header__nav-divideLine"></li>
						<li class="header__navigation-item">
						<a href="Index.php" class="header__nav-link header__nav-signUp">Log Out</a>
						</li>
				...
				<!--cart nav-->
					...
					<div class="header__cart">
						...
						<a href="Cart.php"><i id="cart__icon" class="header__cart-icon fas fa-shopping-cart"></i></a>
						</div>
			...
			<div class="grid__row">
				...
				<div class="grid__column-2">
			 	...
			 	<div class="grid__column-10">
			 	 	...
			 	 	<div class="grid__column-10-domestic">
			  			...
			  			<div id="Domestic" class="Product">
							...
							?>
								  ...
								  <form class="Product__item" method = "POST" action="Cart.php?product_id=<?php echo $product['product_id']?>">
			  						<div >
									  
										<img name="images" class="Product__item-img" src="img/<?=$product['images']?> ">	  	
										<h4 name="product_name" class="Product__item-name"><?=$product['product_name']?></h4>			  									  						
										<div  name="price" class=" Product__item-price"><?=$product['price']?></div>
										<input type="submit" value="Add to Cart" class=" Product__item-btn Product__item-btn-add" name="Addtocart"></input> 
			 		...
			 		<div  class="grid__column-10-imported">
